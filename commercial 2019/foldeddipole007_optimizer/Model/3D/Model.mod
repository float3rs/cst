...
'@ define farfield monitor: farfield (f=3.6)
...
With Monitor 
     ...
     .SetSubvolume "-28.55", "28.55", "0", "26", "-10.17", "10.17" 
...
With Solver
     ...
     .SteadyStateDurationTime "6.58252"
     .SteadyStateDurationTimeAsDistance "1974.76"
...
With Optimizer
  ...
  .ResetParameterList
  .SelectParameter "dfeed", "True" 
  .SetParameterInit "1" 
  .SetParameterMin "0.9" 
  .SetParameterMax "1.1" 
  .SetParameterAnchors "5" 
  .SelectParameter "er", "False" 
  .SetParameterInit "4.35" 
  .SetParameterMin "3.915" 
  .SetParameterMax "4.785" 
  .SetParameterAnchors "5" 
  .SelectParameter "fcen", "False" 
  .SetParameterInit "3.6" 
  .SetParameterMin "3.24" 
  .SetParameterMax "3.96" 
  .SetParameterAnchors "5" 
  .SelectParameter "hdip", "True" 
  .SetParameterInit "3.3" 
  .SetParameterMin "2.97" 
  .SetParameterMax "3.63" 
  .SetParameterAnchors "5" 
  .SelectParameter "hfeed", "False" 
  .SetParameterInit "13" 
  .SetParameterMin "11.7" 
  .SetParameterMax "14.3" 
  .SetParameterAnchors "5" 
  .SelectParameter "k", "False" 
  .SetParameterInit "6.78" 
  .SetParameterMin "5.742" 
  .SetParameterMax "7.018" 
  .SetParameterAnchors "5" 
  .SelectParameter "ldip", "True" 
  .SetParameterInit "28.55" 
  .SetParameterMin "25.695" 
  .SetParameterMax "31.405" 
  .SetParameterAnchors "5" 
  .SelectParameter "offset", "True" 
  .SetParameterInit "0.02" 
  .SetParameterMin "0.018" 
  .SetParameterMax "0.022" 
  .SetParameterAnchors "5" 
  .SelectParameter "tan_d", "False" 
  .SetParameterInit "0.015" 
  .SetParameterMin "0.0135" 
  .SetParameterMax "0.0165" 
  .SetParameterAnchors "5" 
  .SelectParameter "tcond", "False" 
  .SetParameterInit "0.0335" 
  .SetParameterMin "0.03015" 
  .SetParameterMax "0.03685" 
  .SetParameterAnchors "5" 
  .SelectParameter "tsubs", "False" 
  .SetParameterInit "1.5" 
  .SetParameterMin "1.35" 
  .SetParameterMax "1.65" 
  .SetParameterAnchors "5" 
  .SelectParameter "wdip", "True" 
  .SetParameterInit "0.69" 
  .SetParameterMin "0.621" 
  .SetParameterMax "0.759" 
  .SetParameterAnchors "5" 
  .SelectParameter "wfeed", "True" 
  .SetParameterInit "0.34" 
  .SetParameterMin "0.306" 
  .SetParameterMax "0.374" 
  .SetParameterAnchors "5" 
End With 
...
With Optimizer 
  ...
  .SetGoalWeight "1.0" 
  .SetGoalNormNew "MaxDiff" 
  .SetGoal1DCResultName "1D Results\Z Matrix\Z1,1" 
  .SetGoalScalarType "Real" 
  .SetGoalRange "fcen", "fcen" 
