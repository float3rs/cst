...
lifetime=s:rebuild
result=s:1
files=s:field-source (f=3.6)_1.fsm
...
lifetime=s:rebuild
result=s:1
files=s:h-field (f=3.6)_1,1.m3d
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\H-Field\h-field (f=3.6) [1]
files=s:h-field (f=3.6)_1,1.m3d
files=s:h-field (f=3.6)_1,1_m3d.rex
...
lifetime=s:rebuild
result=s:1
treepath=s:2D/3D Results\Surface Current\surface current (f=3.6) [1]
files=s:h-field (f=3.6)_1,1.m3d
files=s:h-field (f=3.6)_1,1_m3d_sct.rex
